...
The data will be downloaded directly from the source and processed here. No preprocess was done to the data. The structure of the data and the first 10 rows of the first 6 columns.
...
```{r echo = TRUE}
str(storm.data)
kable(head(select(storm.data, 1:6), 10))
```
